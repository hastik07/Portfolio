...
function getBotResponse(message) {
    const responses = {
        ...
        'projects': {
            text: 'I have worked on various projects including Blog app, video conference app, and more.',
            emotion: 'neutral'
        },
        'flutter development': {
            text: 'I am fully immersed in the world of flutter development. My journey involves crafting my own apps, integrating cutting-edge technology, and embracing the full spectrum of full-stack flutter development.',
            emotion: 'happy'
        },
        'contact': {
            text: 'You can contact me via email at hastikmangukiya07@gmail.com or through the contact form on this page.',
            emotion: 'neutral'
        },
        'skills': {
            text: 'I have skills in flutter development, android studio, firebase, and more. Feel free to ask about any specific skill!',
            emotion: 'neutral'
        },
        'experience': {
            text: 'I have experience working on various projects in flutter development, android studio, and firebase. Check out my projects section for more details.',
            emotion: 'neutral'
        },
        'education': {
            text: 'I have a background in computer science and have completed various courses and certifications in flutter development.',
            emotion: 'neutral'
        },
        'default': {
